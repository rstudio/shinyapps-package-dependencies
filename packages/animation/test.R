...
ffmpeg_version = system2("ffmpeg", args = "-version", stdout = TRUE)[1]
ffmpeg_version = sub("ffmpeg version", "", ffmpeg_version)
ffmpeg_version = trimws(ffmpeg_version)
ffmpeg_version = sub(" Copyright.*", "", ffmpeg_version)
ffmpeg_version = trimws(ffmpeg_version)
ffmpeg_version
